...
# ==========================================
var tipo_porta: String = "AND"

# Ajustes padrão (para a Etapa 1 e outros alvos)
@export var ajuste_x: float = -177.0
@export var ajuste_y: float = -26.0

# Ajustes exclusivos para o "proximocircuito" (Etapa 2)
@export var ajuste_proximo_x: float = -90.0
@export var ajuste_proximo_y: float = -20.0
...
func mover_para_alvo_e_validar() -> void:
	...
	if no_alvo != null:
		...
		# Espera a subida terminar e valida imediatamente a jogada
